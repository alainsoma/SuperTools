...
package com.superutilities.UnitConverterUltimate.util;


import com.superutilities.R;
import com.superutilities.UnitConverterUltimate.models.Conversion;
import com.superutilities.UnitConverterUltimate.models.TemperatureUnit;
...
public final class Conversions
{
    ...
    private void getStorageConversions()
    {
        ...
        units.add(new Unit(Unit.MEGABIT, R.string.megabit, 0.125, 8.0));
        units.add(new Unit(Unit.MEGABYTE, R.string.megabyte, 1.0, 1.0));
    ...
    private void getPressureConversions()
    {
        ...
        units.add(new Unit(Unit.TECHNICAL_ATMOSPHERE, R.string.technical_atmosphere, 98066.5, 0.0000101971621297792824257));
    ...
    private void getTorqueConversions()
    {
        ...
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(Unit.N_M, R.string.n_m, 1.0, 1.0));
        units.add(new Unit(Unit.FT_LBF, R.string.ft_lbF, 1.3558179483314004, 0.7375621494575464935503));
        units.add(new Unit(Unit.IN_LBF, R.string.in_lbF, 0.1129848290276167, 8.850745793490557922604));
