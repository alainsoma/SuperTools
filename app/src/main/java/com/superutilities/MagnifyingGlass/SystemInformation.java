...
public class SystemInformation {
	...
	public synchronized void setPhoneModel(String phoneModel) {
	...
	public synchronized void setAndroidVersion(String androidVersion) {
	...
	public String toString() {
		return "SystemInformation [versionName=" + versionName
				+ ", packageName=" + packageName + ", filePath=" + filePath
				+ ", phoneModel=" + phoneModel + ", androidVersion="
				+ androidVersion + ", board=" + board + ", brand=" + brand
				+ ", device=" + device + ", display=" + display
				+ ", fingerPrint=" + fingerPrint + ", host=" + host + ", ID="
				+ ID + ", model=" + model + ", product=" + product + ", tags="
				+ tags + ", time=" + time + ", type=" + type + ", user=" + user
				+ "]";
	}
